...
if request.Form("tradeid")="" then
msg=msg&"<br>"&"*所属行业大类不能为空"
end if
if request.Form("smid")="" then
msg=msg&"<br>"&"*所属行业小类不能为空"
end if
if request.Form("企业性质")="" then
msg=msg&"<br>"&"*企业性质不能为空"
end if
...
if request.Form("邮政编码")="" then
msg=msg&"<br>"&"*邮编不能为空"
end if
if request.Form("主负责人")="" then
msg=msg&"<br>"&"*主负责人不能为空"
end if
if request.Form("公司联系电话")="" then
msg=msg&"<br>"&"*公司联系电话不能为空"
end if
