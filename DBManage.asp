...
<title><%if id="" then%>数据库管理<% else %><%=xycms_newstitle(id)%><% end if%><%=wzname%></title>
...
<div id="contain">
  ...
  <div id="dc">
    <div class="dc_l">
      <div class="dc_l_t"><div class="title">数据库管理</div></div>
      <!--
      <div class="dc_l_c">
        <div class="dc_l_c_c">
          <ul>
    ...
    <div class="dc_r">
      <div class="dc_r_t"><div class="title">当前位置：<a href="index.html" target="_self">首页</a> > <%if id="" then%>数据库管理<% else %><%=xycms_newstitle(id)%><% end if%></div></div>
      <div class="dc_r_c">
        <div class="dc_r_c_c">
          <div class="nlist">
            <ul>
