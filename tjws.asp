...
<title>温商信息添加</title>
<META name="keywords" content="温商信息添加|泰顺商人网-泰顺商人自己的平台">
<META name="description" content="温商信息添加|泰顺商人网-泰顺商人自己的平台">
...
demo9.onmouseout=function() {MyMar3=setInterval(Marquee3,speed3)} 
        ...
        <td width="739" valign="top">
		 <table width="739" border="0" cellspacing="0" cellpadding="0">
				...
				</strong>您当前位置：<a href="/index.asp" class="other">首页</a> &gt;   <span class="STYLE38">温商信息添加</span></td>
                </tr>
            </table></td>
          </tr>
           <tr>
...
19. 通知。 
除非另有明确规定，任何通知应以电子邮件形式发送，(就 泰顺商人网  而言) 电子邮件地址为 tzsrw#tzsrw.cn，或 (就您而言) 发送到您在登记过程中向 温顺商人网  提供的电子邮件地址，或有关方指明的该等其他地址。在电子邮件发出二十四 (24) 小时后，通知应被视为已送达，除非发送人被告知相关电子邮件地址已作废。或者，泰顺商人网  可通过邮资预付挂号邮件并要求回执的方式，将通知发到您在登记过程中向 泰顺商人网  提供的地址。在该情况下，在付邮当日三 (3) 天后通知被视为已送达。 
...
subcat[638] = new Array("异地温顺商会","36","643");
        
subcat[639] = new Array("智能化设计、智能化系统","12","644");
        
subcat[640] = new Array("温顺异地商会","1","645");
...
//-->
                                      ...
                                      <CENTER>
   <FORM name=addnew onSubmit="return checkform();" action="addnewdataws.asp?ac=adduser" method=post>
                                    ...
                                    <center>
                                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber122" bgcolor="#F5F5F5" height="25">
                                          ...
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input name="姓名" id="姓名" type="text"  size="30" >  
                                            <font color="#EC5106">*</font> <br>         
                                          </td>
                                        </tr>
			    <tr> 
                                          <td width="24%" height="25" align="right">性别：</td>
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input name="性别" id="性别" type="text"  size="30" >  
                                            <font color="#EC5106">*</font> <br>         
                                          </td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">手机：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="手机" id="手机" maxLength=40 >
                                            <br>
</td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">工作单位：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="工作单位" id="工作单位" maxLength=40 >
                                            <br>
</td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">工作职务：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="工作职务" id="工作职务" maxLength=40 >
                                            <br>
</td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">所属商会：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="所属商会" id="所属商会" maxLength=40 >
</td>
                                        </tr>
			<tr> 
			<tr> 
                                          <td width="24%" align="right" height="25">商会职务：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="商会职务" id="商会职务" maxLength=40 >
</td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">籍贯：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="籍贯" id="籍贯" maxLength=40 >
                                            <br>
</td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">身份证：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="身份证" id="身份证" maxLength=40 >
                                            <br>
</td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">所在区域：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="所在区域" id="所在区域" maxLength=40 >
                                            <font color="#EC5106">在什么县或区</font> <br>    
</td>
                                        </tr>
				<tr> 
                                          <td width="24%" align="right" height="25">邮编：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="邮编" id="邮编" maxLength=40 >
                                               
</td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">联系地址：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="联系地址" id="联系地址" maxLength=40 >
</td>
                                        </tr>
