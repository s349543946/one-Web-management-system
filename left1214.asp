...
<table width="185" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="8" /></td>
                <td width="91%"><a href="../search籍贯查询.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">负责人籍贯查询</a></td>
              </tr>
  <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="8" /></td>
  ...
  <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="8" /></td>
                <td width="91%"><a href="../search温商名下查询.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">温商名下企业信息查询</a></td>
              </tr>
              <tr>         
 ...
 <td width="91%"> <%if qx="1" then %><a  href="../add_common1.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">企业信息添加</a>
<%elseif qx="2" then %><a  href="../add_common11sh.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">企业信息添加</a>

<%end if%>
   </tr>
                     <tr>
                <td width="9%" height="24" ><img id="xy_xt5" src="images/ico06.gif" width="8" height="8" /></td>
 <td width="91%"> <%if qx="1" then %><a  href="../add_common.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">温商名下企业信息添加</a>
<%elseif qx="2" then %><a  href="../add_commonsh1.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">温商名下企业信息添加</a>
