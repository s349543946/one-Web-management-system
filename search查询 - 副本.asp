...
if qx="2" then
exec="select * from company_info where  所属商会 = '"&sh&"' ORDER BY company_id "
elseif qx="1" then
exec="select * from company_info  ORDER BY company_id "
elseif qx="3" then
	exec="select * from company_info "
	xz=trim(xz)
	if  xz<>"" then	
		exec=exec+"where ((主负责人 in (select CInt(ID) from wenshangxinxi where 籍贯 like '%"&xz&"%')) or (副负责人 in (select CInt(ID) from wenshangxinxi where 籍贯 like '%"&xz&"%')) )"
	end if
...
企业名称<input type="text" name="公司名称" id="公司名称" size="20"> 
企业类型<input type="text" name="企业类型" id="企业类型" size="20"> 
企业负责人<input type="text" name="企业负责人" id="企业负责人" size="20">
省份<input type="text" name="省份" id="省份" size="20">
城市<input type="text" name="城市" id="城市" size="20">
