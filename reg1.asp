...
function Jtrim(str)
{
        ...
        return trimstr;
                ...
                <td width="200" align="center">您好,欢迎光临泰顺商人网</td>
...
<script type="text/javascript" src="My97DatePicker/WdatePicker.js"></script>
        ...
        <td width="739" valign="top">
		 <table width="739" border="0" cellspacing="0" cellpadding="0">
				...
				</strong>您当前位置：<a href="/index.asp" class="other">首页</a> &gt;   <span class="STYLE38">注册会员</span></td>
                </tr>
            </table></td>
          </tr>
           <tr>
                              ...
                              <TBODY>
                                <TR> 
                                  <TD width="100%" height=30> <P align=center>+++ 
                                      会员注册 +++  <font color="#EC5106">(*必填)</font></P></TD>
                                </TR>
...
//-->
                                      ...
                                      <CENTER>
   <FORM name=addnew onSubmit="return checkform();" action="addnewdata.asp?ac=adduser" method=post>
                                      ...
                                      <td width="100%"><table width="94%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#111111" id="AutoNumber115" style="border-collapse: collapse">
                                          ...
                                          <tr>
                                            <td width="100%" height="25" align="center" bgcolor="#5E6378">
                                              <p align="center"><font color="#FFFFFF">=====&gt; 企 业 会 员 的 基 本 信 息 &lt;=====</font> </td>
                                          </tr>
                                        </table></td>
                                    </tr>
                                  </table>
								  <table width="94%" height="25" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#BDBFC8" bgcolor="#F5F5F5" id="AutoNumber122" style="border-collapse: collapse">
                                        <tr> 
                                          <td width="24%" align="right" height="25">用户名称：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="username" id="username" size="25" maxLength=40 onKeyUp="value=value.replace(/[^\w\.\/]/ig,'')">
                                       <font color="#EC5106">*</font>
                                            <font color="#666666"><br>
                                            5-20位，请使用英文(a-z、A-Z)、数字(0-9)，不区分大小写<br>
建议与公司名相关，易记。如“温州商人网”的登录名是wzsrw<br>
一旦注册成功，不可修改；建议使用公司名的字母缩写。</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">登陆密码：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="password" id="password" maxlength=30 size="25" >  <font color="#EC5106">*</font><br>
<font color="#666666">6-20位；只限数字(0-9)和英文(a-z、A-Z)，不区分大小写 
                        建议为字母和数字结合，便于记忆，但不易被猜出， 不能与用户名相同。</font></td>
                                        </tr>
										 <tr> 
                                          <td width="24%" align="right" height="25">确认密码：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="password2" id="password2"  maxlength=30 size="25" >
                                            <font color="#EC5106">*</font><br>
                                             <font color="#666666">请再输入一遍您上面填写的密码。</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">提示问题：</td>
                                          <td width="76%" height="25"style="padding-left:8px ">
                                            <input type="text" name="question" id="question" maxLength=40 >
                                            <font color="#EC5106">*</font><br>
<font color="#666666"> 在您忘记了密码，需要找回密码的时候，我们的系统会要求您回答这个问题。<BR>
比如，您可以把密码提示答案设为：你的电话号码是什么？</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">提示答案：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="answer" id="answer" maxLength=40 >
                                            <font color="#EC5106">*</font><br>

                                          <font color="#666666"> 
                                          如果您的电话号码是86062878，那您就可以把密码提示答案填写为：86062878。<BR>
                                        （请牢记这个答案，以便密码丢失时回答系统的提问。如果您的回答正确，系统就会自动把密码显示给您。）</font></td>
                                        </tr>
                                      </table>
									  ...
									  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber116" bgcolor="#F5F5F5">
                                        <tr> 
                                          <td width="24%" height="25" align="right">公司名称：</td>
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input name="公司名称" type="text"  size="30" >  
                                            <font color="#EC5106">*</font> <br>
                          <font color="#666666">请尽量用中文填写在工商局注册的公司/商号全称；<br>
                          无商号的个体经营者填写执照上的姓名，如：张三（个体经营）</font>
                                          </td>
                                        </tr>
										<tr> 
                                          <td width="24%" height="25" align="right">所属行业：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <font color="#EC5106">

<select name="tradeid" onChange="changelocation(document.addnew.tradeid.options[document.addnew.tradeid.selectedIndex].value)" size="1">
 <option value="" selected >选择大类</option>

 <option value=1>党政 国家机关 社会团体</option>

 <option value=2>纺织、服装、鞋帽、皮革</option>

 <option value=3>餐饮、娱乐、宾馆、旅游、购物</option>

 <option value=4>医疗保健、社会福利</option>

 <option value=5>公关、广告、会展、咨询</option>

 <option value=6>印刷、包装、纸制品</option>

 <option value=7>艺品、礼品、钟表眼镜、烟具打火机 </option>

 <option value=8>金属、非金属材料及其制品</option>

 <option value=9>机械设备、通用零部件</option>

 <option value=10>交通、物流、邮政</option>

 <option value=11>金融、保险、证券投资、贸易</option>

 <option value=12>工程、建筑、房地产、装潢</option>

 <option value=13>新闻、出版、科研、教育、文体</option>

 <option value=14>石油化工、橡胶塑料 </option>

 <option value=15>电子电器、仪器仪表</option>

 <option value=16>农业、粮油食品 </option>

 <option value=17>日常生活、社会服务</option>

 <option value=18>家居生活用品</option>
 ...
 <select name="smid">
    <option value="">选择小类</option>
</select>                                           </font> <font color="#EC5106"></font></td>
                                        </tr>
										
                                        <tr> 
                                          <td width="24%" height="25" align="right">企业性质：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <SELECT size=1 name=企业性质 >
			     ...
			     <OPTION value=股份制企业 >股份制企业</OPTION>
                                        ...
                                        <tr> 
                                          <td width="24%" height="25" align="right">注册资金：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="注册资金" id="注册资金">
                                            万人民币</td>
                                        </tr>
 			<tr> 
                                          <td width="24%" height="25" align="right">市场总数：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="市场总数" id="市场总数">
                                            个</td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" height="25" align="right">员工人数：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="员工人数" id="员工人数" onKeyUp="value=value.replace(/[^\d]/g,'')"/> 
                                          人</td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" height="25" align="right">所在地区：</td>
                                          <td width="76%" height="25"> &nbsp; 
...
subcat1[0] = new Array("杭州市","1","1");
        
subcat1[1] = new Array("嘉兴市","1","2");
        
subcat1[2] = new Array("北京市","2","4");
        
subcat1[3] = new Array("金华市","1","6");
        
subcat1[4] = new Array("衢州市","1","7");
        
subcat1[5] = new Array("丽水市","1","8");
        
subcat1[6] = new Array("宁波市","1","9");
        
subcat1[7] = new Array("绍兴市","1","10");
        
subcat1[8] = new Array("台州市","1","11");
        
subcat1[9] = new Array("温州市","1","12");
        
subcat1[10] = new Array("舟山市","1","13");
        
subcat1[11] = new Array("湖州市","1","14");
        
subcat1[12] = new Array("济南市","3","21");
        
subcat1[13] = new Array("东营市","3","22");
        
subcat1[14] = new Array("滨州市","3","23");
        
subcat1[15] = new Array("淄博市","3","24");
        
subcat1[16] = new Array("德州市","3","25");
        
subcat1[17] = new Array("济宁市","3","26");
        
subcat1[18] = new Array("聊城市","3","27");
        
subcat1[19] = new Array("临沂市","3","28");
        
subcat1[20] = new Array("莱芜市","3","29");
        
subcat1[21] = new Array("青岛市","3","30");
        
subcat1[22] = new Array("日照市","3","31");
        
subcat1[23] = new Array("威海市","3","32");
        
subcat1[24] = new Array("泰安市","3","33");
        
subcat1[25] = new Array("潍坊市","3","34");
        
subcat1[26] = new Array("烟台市","3","35");
        
subcat1[27] = new Array("菏泽市","3","36");
        
subcat1[28] = new Array("枣庄市","3","37");
        
subcat1[29] = new Array("南京市","4","38");
        
subcat1[30] = new Array("淮安市","4","39");
        
subcat1[31] = new Array("常州市","4","40");
        
subcat1[32] = new Array("连云港市","4","41");
        
subcat1[33] = new Array("南通市","4","42");
        
subcat1[34] = new Array("徐州市","4","43");
        
subcat1[35] = new Array("苏州市","4","44");
        
subcat1[36] = new Array("无锡市","4","45");
        
subcat1[37] = new Array("盐城市","4","46");
        
subcat1[38] = new Array("扬州市","4","47");
        
subcat1[39] = new Array("镇江市","4","48");
        
subcat1[40] = new Array("泰顺市","4","49");
        
subcat1[41] = new Array("宿迁市","4","50");
        
subcat1[42] = new Array("上海市","5","51");
        
subcat1[43] = new Array("广州市","6","52");
        
subcat1[44] = new Array("佛山市","6","53");
        
subcat1[45] = new Array("惠州市","6","54");
        
subcat1[46] = new Array("东莞市","6","55");
        
subcat1[47] = new Array("江门市","6","56");
        
subcat1[48] = new Array("揭阳市","6","57");
        
subcat1[49] = new Array("潮州市","6","58");
        
subcat1[50] = new Array("茂名市","6","59");
        
subcat1[51] = new Array("梅州市","6","60");
        
subcat1[52] = new Array("清远市","6","61");
        
subcat1[53] = new Array("汕头市","6","62");
        
subcat1[54] = new Array("汕尾市","6","63");
        
subcat1[55] = new Array("深圳市","6","64");
        
subcat1[56] = new Array("韶关市","6","65");
        
subcat1[57] = new Array("阳江市","6","66");
        
subcat1[58] = new Array("河源市","6","67");
        
subcat1[59] = new Array("云浮市","6","68");
        
subcat1[60] = new Array("中山市","6","69");
        
subcat1[61] = new Array("珠海市","6","70");
        
subcat1[62] = new Array("湛江市","6","71");
        
subcat1[63] = new Array("深圳市","6","72");
        
subcat1[64] = new Array("江门市","6","73");
        
subcat1[65] = new Array("合肥市","7","74");
        
subcat1[66] = new Array("芜湖市","7","75");
        
subcat1[67] = new Array("安庆市","7","76");
        
subcat1[68] = new Array("巢湖市","7","77");
        
subcat1[69] = new Array("滁州市","7","78");
        
subcat1[70] = new Array("淮南市","7","79");
        
subcat1[71] = new Array("马鞍山市","7","80");
        
subcat1[72] = new Array("宿州市","7","81");
        
subcat1[73] = new Array("宣州市","7","82");
        
subcat1[74] = new Array("蚌埠市","7","83");
        
subcat1[75] = new Array("池州市","7","84");
        
subcat1[76] = new Array("福州市","8","85");
        
subcat1[77] = new Array("龙岩市","8","86");
        
subcat1[78] = new Array("南平市","8","87");
        
subcat1[79] = new Array("宁德市","8","88");
        
subcat1[80] = new Array("莆田市","8","89");
        
subcat1[81] = new Array("泉州市","8","90");
        
subcat1[82] = new Array("三明市","8","91");
        
subcat1[83] = new Array("厦门市","8","92");
        
subcat1[84] = new Array("漳州市","8","93");
        
subcat1[85] = new Array("重庆市","9","94");
        
subcat1[86] = new Array("渝北区","9","95");
        
subcat1[87] = new Array("永川区","9","96");
        
subcat1[88] = new Array("万州区","9","97");
        
subcat1[89] = new Array("兰州市","10","98");
        
subcat1[90] = new Array("甘南藏族自治州","10","99");
        
subcat1[91] = new Array("定西市","10","100");
        
subcat1[92] = new Array("江津区","9","101");
        
subcat1[93] = new Array("嘉峪关市","10","102");
        
subcat1[94] = new Array("金昌市","10","103");
        
subcat1[95] = new Array("酒泉市","10","104");
        
subcat1[96] = new Array("临夏回族自治州","10","105");
        
subcat1[97] = new Array("陇南市","10","106");
        
subcat1[98] = new Array("平凉市","10","107");
        
subcat1[99] = new Array("庆阳市","10","108");
        
subcat1[100] = new Array("天水市","10","109");
        
subcat1[101] = new Array("武威市","10","110");
        
subcat1[102] = new Array("张掖市","10","111");
        
subcat1[103] = new Array("南宁市","11","112");
        
subcat1[104] = new Array("防城港市","11","113");
        
subcat1[105] = new Array("北海市","11","114");
        
subcat1[106] = new Array("百色市","11","115");
        
subcat1[107] = new Array("桂林市","11","117");
        
subcat1[108] = new Array("柳州市","11","119");
        
subcat1[109] = new Array("钦州市","11","121");
        
subcat1[110] = new Array("梧州市","11","123");
        
subcat1[111] = new Array("河池市","11","124");
        
subcat1[112] = new Array("玉林市","11","125");
        
subcat1[113] = new Array("贵港市","11","126");
        
subcat1[114] = new Array("贵阳市","12","127");
        
subcat1[115] = new Array("毕节地区","12","128");
        
subcat1[116] = new Array("遵义市","12","129");
        
subcat1[117] = new Array("安顺市","12","130");
        
subcat1[118] = new Array("六盘水市","12","131");
        
subcat1[119] = new Array("黔东南苗族侗族自治州","12","132");
        
subcat1[120] = new Array("黔南布依族苗族自治州","12","133");
        
subcat1[121] = new Array("黔西南布依族苗族自治州","12","134");
        
subcat1[122] = new Array("铜仁地区","12","135");
        
subcat1[123] = new Array("三亚市","13","136");
        
subcat1[124] = new Array("海口市","13","137");
        
subcat1[125] = new Array("石家庄市","14","138");
        
subcat1[126] = new Array("邯郸市","14","139");
        
subcat1[127] = new Array("邢台市","14","140");
        
subcat1[128] = new Array("保定市","14","141");
        
subcat1[129] = new Array("张家口市","14","142");
        
subcat1[130] = new Array("沧州市","14","143");
        
subcat1[131] = new Array("承德市","14","144");
        
subcat1[132] = new Array("廊坊市","14","145");
        
subcat1[133] = new Array("秦皇岛市","14","146");
        
subcat1[134] = new Array("唐山市","14","147");
        
subcat1[135] = new Array("衡水市","14","148");
        
subcat1[136] = new Array("郑州市","15","149");
        
subcat1[137] = new Array("开封市","15","150");
        
subcat1[138] = new Array("驻马店市","15","151");
        
subcat1[139] = new Array("安阳市","15","152");
        
subcat1[140] = new Array("焦作市","15","153");
        
subcat1[141] = new Array("洛阳市","15","154");
        
subcat1[142] = new Array("濮阳市","15","155");
        
subcat1[143] = new Array("漯河市","15","156");
        
subcat1[144] = new Array("南阳市","15","157");
        
subcat1[145] = new Array("平顶山市","15","158");
        
subcat1[146] = new Array("新乡市","15","159");
        
subcat1[147] = new Array("信阳市","15","160");
        
subcat1[148] = new Array("许昌市","15","161");
        
subcat1[149] = new Array("商丘市","15","162");
        
subcat1[150] = new Array("三门峡市","15","163");
        
subcat1[151] = new Array("鹤壁市","15","164");

        
subcat1[152] = new Array("周口市","15","165");
        
subcat1[153] = new Array("哈尔滨市","16","166");
        
subcat1[154] = new Array("大庆市","16","167");
        
subcat1[155] = new Array("大兴安岭地区","16","168");
        
subcat1[156] = new Array("鸡西市","16","169");
        
subcat1[157] = new Array("佳木斯市","16","170");
        
subcat1[158] = new Array("牡丹江市","16","171");
        
subcat1[159] = new Array("齐齐哈尔市","16","172");
        
subcat1[160] = new Array("七台河市","16","173");
        
subcat1[161] = new Array("双鸭山市","16","174");
        
subcat1[162] = new Array("绥化市","16","175");
        
subcat1[163] = new Array("鹤岗市","16","177");
        
subcat1[164] = new Array("黑河市","16","178");
        
subcat1[165] = new Array("伊春市","16","179");
        
subcat1[166] = new Array("武汉市","17","180");
        
subcat1[167] = new Array("黄冈市","17","181");
        
subcat1[168] = new Array("黄石市","17","182");
        
subcat1[169] = new Array("恩施土家族苗族自治州","17","183");
        
subcat1[170] = new Array("鄂州市","17","184");
        
subcat1[171] = new Array("荆门市","17","185");
        
subcat1[172] = new Array("荆州市","17","186");
        
subcat1[173] = new Array("孝感市","17","187");
        
subcat1[174] = new Array("十堰市","17","188");
        
subcat1[175] = new Array("襄樊市","17","189");
        
subcat1[176] = new Array("咸宁市","17","190");
        
subcat1[177] = new Array("宜昌市","17","191");
        
subcat1[178] = new Array("长沙市","18","192");
        
subcat1[179] = new Array("怀化市","18","193");
        
subcat1[180] = new Array("郴州市","18","194");
        
subcat1[181] = new Array("常德市","18","195");
        
subcat1[182] = new Array("娄底市","18","196");
        
subcat1[183] = new Array("邵阳市","18","197");
        
subcat1[184] = new Array("湘潭市","18","198");
        
subcat1[185] = new Array("湘西土家族苗族自治州","18","199");
        
subcat1[186] = new Array("衡阳市","18","200");
        
subcat1[187] = new Array("永州市","18","201");
        
subcat1[188] = new Array("益阳市","18","202");
        
subcat1[189] = new Array("岳阳市","18","203");
        
subcat1[190] = new Array("株洲市","18","204");
        
subcat1[191] = new Array("张家界市","18","205");
        
subcat1[192] = new Array("南昌市","19","206");
        
subcat1[193] = new Array("抚州市","19","207");
        
subcat1[194] = new Array("赣州市","19","208");
        
subcat1[195] = new Array("吉安市","19","209");
        
subcat1[196] = new Array("景德镇市","19","210");
        
subcat1[197] = new Array("九江市","19","211");
        
subcat1[198] = new Array("萍乡市","19","212");
        
subcat1[199] = new Array("新余市","19","213");
        
subcat1[200] = new Array("上饶市","19","214");
        
subcat1[201] = new Array("鹰潭市","19","215");
        
subcat1[202] = new Array("宜春市","19","216");
        
subcat1[203] = new Array("长春市","20","217");
        
subcat1[204] = new Array("白城市","20","218");
        
subcat1[205] = new Array("白山市","20","219");
        
subcat1[206] = new Array("吉林市","20","220");
        
subcat1[207] = new Array("辽源市","20","221");
        
subcat1[208] = new Array("四平市","20","222");
        
subcat1[209] = new Array("松原市","20","223");
        
subcat1[210] = new Array("通化市","20","224");
        
subcat1[211] = new Array("延边朝鲜族自治州","20","225");
        
subcat1[212] = new Array("沈阳市","21","226");
        
subcat1[213] = new Array("大连市","21","227");
        
subcat1[214] = new Array("阜新市","21","228");
        
subcat1[215] = new Array("抚顺市","21","229");
        
subcat1[216] = new Array("本溪市","21","230");
        
subcat1[217] = new Array("鞍山市","21","231");
        
subcat1[218] = new Array("丹东市","21","232");
        
subcat1[219] = new Array("锦州市","21","233");
        
subcat1[220] = new Array("朝阳市","21","234");
        
subcat1[221] = new Array("辽阳市","21","235");
        
subcat1[222] = new Array("盘锦市","21","236");
        
subcat1[223] = new Array("铁岭市","21","237");
        
subcat1[224] = new Array("营口市","21","238");
        
subcat1[225] = new Array("锦西市","21","239");
        
subcat1[226] = new Array("呼和浩特市","22","240");
        
subcat1[227] = new Array("阿拉善盟","22","241");
        
subcat1[228] = new Array("巴彦淖尔市","22","242");
        
subcat1[229] = new Array("包头市","22","243");
        
subcat1[230] = new Array("赤峰市","22","244");
        
subcat1[231] = new Array("兴安盟","22","245");
        
subcat1[232] = new Array("乌兰察布市","22","246");
        
subcat1[233] = new Array("乌海市","22","247");
        
subcat1[234] = new Array("锡林郭勒盟","22","248");
        
subcat1[235] = new Array("呼伦贝尔市","22","249");
        
subcat1[236] = new Array("银川市","23","252");
        
subcat1[237] = new Array("吴忠市","23","253");
        
subcat1[238] = new Array("石嘴山市","23","254");
        
subcat1[239] = new Array("固原市","23","255");
        
subcat1[240] = new Array("西宁市","24","256");
        
subcat1[241] = new Array("海东地区","24","257");
        
subcat1[242] = new Array("海南藏族自治州","24","258");
        
subcat1[243] = new Array("海北藏族自治州","24","259");
        
subcat1[244] = new Array("黄南藏族自治州","24","260");
        
subcat1[245] = new Array("果洛藏族自治州","24","261");
        
subcat1[246] = new Array("海西蒙古族藏族自治州","24","262");
        
subcat1[247] = new Array("太原市","25","263");
        
subcat1[248] = new Array("大同市","25","264");
        
subcat1[249] = new Array("晋城市","25","265");
        
subcat1[250] = new Array("晋中市","25","266");
        
subcat1[251] = new Array("长治市","25","267");
        
subcat1[252] = new Array("临汾市","25","268");
        
subcat1[253] = new Array("吕梁市","25","269");
        
subcat1[254] = new Array("忻州市","25","270");
        
subcat1[255] = new Array("朔州市","25","271");
        
subcat1[256] = new Array("阳泉市","25","272");
        
subcat1[257] = new Array("运城市","25","273");
        
subcat1[258] = new Array("西安市","26","274");
        
subcat1[259] = new Array("宝鸡市","26","275");
        
subcat1[260] = new Array("安康市","26","276");
        
subcat1[261] = new Array("商洛市","26","277");
        
subcat1[262] = new Array("铜川市","26","278");
        
subcat1[263] = new Array("渭南市","26","279");
        
subcat1[264] = new Array("咸阳市","26","280");
        
subcat1[265] = new Array("延安市","26","281");
        
subcat1[266] = new Array("汉中市","26","282");
        
subcat1[267] = new Array("榆林市","26","283");
        
subcat1[268] = new Array("成都市","27","284");
        
subcat1[269] = new Array("达州市","27","285");
        
subcat1[270] = new Array("甘孜藏族自治州","27","286");
        
subcat1[271] = new Array("自贡市","27","287");
        
subcat1[272] = new Array("阿坝藏族羌族自治州","27","288");
        
subcat1[273] = new Array("巴中市","27","289");
        
subcat1[274] = new Array("德阳市","27","290");
        
subcat1[275] = new Array("广安市","27","291");
        
subcat1[276] = new Array("广元市","27","292");
        
subcat1[277] = new Array("凉山彝族自治州","27","293");
        
subcat1[278] = new Array("乐山市","27","294");
        
subcat1[279] = new Array("攀枝花市","27","295");
        
subcat1[280] = new Array("南充市","27","296");
        
subcat1[281] = new Array("内江市","27","297");
        
subcat1[282] = new Array("泸州市","27","298");
        
subcat1[283] = new Array("绵阳市","27","299");
        
subcat1[284] = new Array("遂宁市","27","300");
        
subcat1[285] = new Array("雅安市","27","301");
        
subcat1[286] = new Array("宜宾市","27","302");
        
subcat1[287] = new Array("天津市","28","303");
        
subcat1[288] = new Array("乌鲁木齐市","29","304");
        
subcat1[289] = new Array("喀什地区","29","305");
        
subcat1[290] = new Array("克孜勒苏柯尔克孜自治州","29","306");
        
subcat1[291] = new Array("克拉玛依市","29","307");
        
subcat1[292] = new Array("阿克苏地区","29","308");
        
subcat1[293] = new Array("阿勒泰地区","29","309");
        
subcat1[294] = new Array("巴音郭楞蒙古自治州","29","310");
        
subcat1[295] = new Array("哈密地区","29","311");
        
subcat1[296] = new Array("博尔塔拉蒙古自治州","29","312");
        
subcat1[297] = new Array("昌吉回族自治州","29","313");
        
subcat1[298] = new Array("塔城地区","29","314");
        
subcat1[299] = new Array("吐鲁番地区","29","315");
        
subcat1[300] = new Array("和田地区","29","316");
        
subcat1[301] = new Array("伊犁地区","29","317");
        
subcat1[302] = new Array("伊犁哈萨克自治州","29","318");
        
subcat1[303] = new Array("克拉玛依市","29","319");
        
subcat1[304] = new Array("拉萨市","30","320");
        
subcat1[305] = new Array("阿里地区","30","321");
        
subcat1[306] = new Array("昌都地区","30","322");
        
subcat1[307] = new Array("林芝地区","30","323");
        
subcat1[308] = new Array("那曲地区","30","324");
        
subcat1[309] = new Array("山南地区","30","325");
        
subcat1[310] = new Array("日喀则地区","30","326");
        
subcat1[311] = new Array("昆明市","31","327");
        
subcat1[312] = new Array("大理白族自治州","31","328");
        
subcat1[313] = new Array("保山市","31","330");
        
subcat1[314] = new Array("德宏傣族景颇族自治州","31","331");
        
subcat1[315] = new Array("迪庆藏族自治州","31","332");
        
subcat1[316] = new Array("楚雄彝族自治州","31","333");
        
subcat1[317] = new Array("临沧市","31","334");
        
subcat1[318] = new Array("丽江市","31","335");
        
subcat1[319] = new Array("怒江傈僳族自治州","31","336");
        
subcat1[320] = new Array("曲靖市","31","337");
        
subcat1[321] = new Array("普洱市","31","338");
        
subcat1[322] = new Array("西双版纳傣族自治州","31","339");
        
subcat1[323] = new Array("文山壮族苗族自治州","31","340");
        
subcat1[324] = new Array("红河哈尼族彝族自治州","31","341");
        
subcat1[325] = new Array("玉溪市","31","342");
        
subcat1[326] = new Array("昭通市","31","343");
        
subcat1[327] = new Array("香港岛","32","344");
        
subcat1[328] = new Array("澳门半岛","33","345");
        
subcat1[329] = new Array("台北市","34","346");
        
subcat1[330] = new Array("国外与其它","35","347");
        
subcat1[331] = new Array("赤壁市","17","348");
        
subcat1[332] = new Array("通城县","17","349");
        
subcat1[333] = new Array("崇阳县","17","350");
        
subcat1[334] = new Array("阜阳市","7","351");
        
subcat1[335] = new Array("淮北市","7","352");
        
subcat1[336] = new Array("黄山市","7","353");
        
subcat1[337] = new Array("六安市","7","354");
        
subcat1[338] = new Array("铜陵市","7","355");
        
subcat1[339] = new Array("亳州市","7","356");
        
subcat1[340] = new Array("义乌市","1","357");
        
subcat1[341] = new Array("常熟市","4","358");
        
subcat1[342] = new Array("肇庆市","6","359");
        
subcat1[343] = new Array("鄂尔多斯市","22","360");
        
subcat1[344] = new Array("葫芦岛市","21","362");
        
subcat1[345] = new Array("通辽市","22","364");
        
subcat1[346] = new Array("奉贤区","5","365");
        
subcat1[347] = new Array("宝山区","5","366");
        
subcat1[348] = new Array("松江区","5","367");
        
subcat1[349] = new Array("普陀区","5","368");
        
subcat1[350] = new Array("南汇区","5","369");
        
subcat1[351] = new Array("黄浦区","5","370");
        
subcat1[352] = new Array("卢湾区","5","371");
        
subcat1[353] = new Array("徐汇区","5","373");
        
subcat1[354] = new Array("长宁区","5","374");
        
subcat1[355] = new Array("静安区","5","375");
        
subcat1[356] = new Array("虹口区","5","376");
        
subcat1[357] = new Array("闸北区","5","377");
        
subcat1[358] = new Array("杨浦区","5","378");
        
subcat1[359] = new Array("闵行区","5","379");
        
subcat1[360] = new Array("浦东新区","5","380");
        
subcat1[361] = new Array("青浦区","5","381");
        
subcat1[362] = new Array("嘉定区","5","382");
        
subcat1[363] = new Array("金山区","5","383");
        
subcat1[364] = new Array("上海县","5","384");
        
subcat1[365] = new Array("崇明县","5","385");
        
subcat1[366] = new Array("海淀区","2","386");
        
subcat1[367] = new Array("石景山区","2","387");
        
subcat1[368] = new Array("丰台区","2","388");
        
subcat1[369] = new Array("朝阳区","2","389");
        
subcat1[370] = new Array("宣武区","2","390");
        
subcat1[371] = new Array("崇文区","2","391");
        
subcat1[372] = new Array("西城区","2","392");
        
subcat1[373] = new Array("东城区","2","393");
        
subcat1[374] = new Array("平谷区","2","394");
        
subcat1[375] = new Array("怀柔区","2","395");
        
subcat1[376] = new Array("大兴区","2","396");
        
subcat1[377] = new Array("昌平区","2","397");
        
subcat1[378] = new Array("顺义区","2","398");
        
subcat1[379] = new Array("通州区","2","399");
        
subcat1[380] = new Array("房山区","2","400");
        
subcat1[381] = new Array("门头沟区","2","401");
        
subcat1[382] = new Array("通县","2","402");
        
subcat1[383] = new Array("平台","2","403");
        
subcat1[384] = new Array("延庆县","2","404");
        
subcat1[385] = new Array("密云县","2","405");
        
subcat1[386] = new Array("和平区","28","406");
        
subcat1[387] = new Array("西青区","28","407");
        
subcat1[388] = new Array("塘沽区","28","408");
        
subcat1[389] = new Array("南开区","28","409");
        
subcat1[390] = new Array("津南区","28","410");
        
subcat1[391] = new Array("红桥区","28","411");
        
subcat1[392] = new Array("河西区","28","412");
        
subcat1[393] = new Array("河东区","28","413");
        
subcat1[394] = new Array("河北区","28","414");
        
subcat1[395] = new Array("汉沽区","28","415");
        
subcat1[396] = new Array("东丽区","28","416");
        
subcat1[397] = new Array("大港区","28","417");
        
subcat1[398] = new Array("北辰区","28","418");
        
subcat1[399] = new Array("滨海新区","28","419");
        
subcat1[400] = new Array("宝坻区","28","420");
        
subcat1[401] = new Array("武清区","28","421");
        
subcat1[402] = new Array("蓟县","28","422");
        
subcat1[403] = new Array("静海县","28","423");
        
subcat1[404] = new Array("宁河县","28","424");
        
subcat1[405] = new Array("合川区","9","425");
        
subcat1[406] = new Array("长寿区","9","426");
        
subcat1[407] = new Array("巴南区","9","427");
        
subcat1[408] = new Array("南川区","9","428");
        
subcat1[409] = new Array("黔江区","9","430");
        
subcat1[410] = new Array("双桥区","9","431");
        
subcat1[411] = new Array("万盛区","9","432");
        
subcat1[412] = new Array("北碚区","9","433");
        
subcat1[413] = new Array("南岸区","9","434");
        
subcat1[414] = new Array("九龙坡区","9","435");
        
subcat1[415] = new Array("沙坪坝区","9","436");
        
subcat1[416] = new Array("江北区","9","437");
        
subcat1[417] = new Array("大渡口区","9","438");
        
subcat1[418] = new Array("渝中区","9","439");
        
subcat1[419] = new Array("涪陵区","9","440");
        
subcat1[420] = new Array("潼南县","9","441");
        
subcat1[421] = new Array("铜梁县","9","442");
        
subcat1[422] = new Array("荣昌县","9","443");
        
subcat1[423] = new Array("綦江县","9","444");
        
subcat1[424] = new Array("大足县","9","445");
        
subcat1[425] = new Array("璧山县","9","446");
        
subcat1[426] = new Array("万县","9","447");
        
subcat1[427] = new Array("巴县","9","448");
        
subcat1[428] = new Array("巫溪县","9","449");
        
subcat1[429] = new Array("巫山县","9","450");
        
subcat1[430] = new Array("奉节县","9","451");
        
subcat1[431] = new Array("云阳县","9","452");
        
subcat1[432] = new Array("开县","9","453");
        
subcat1[433] = new Array("忠县","9","454");
        
subcat1[434] = new Array("武隆县","9","455");
        
subcat1[435] = new Array("垫江县","9","456");
        
subcat1[436] = new Array("丰都县","9","457");
        
subcat1[437] = new Array("城口县","9","458");
        
subcat1[438] = new Array("梁平县","9","459");
        
subcat1[439] = new Array("秀山土家族苗族自治县","9","460");
        
subcat1[440] = new Array("酉阳土家族苗族自治县","9","461");
        
subcat1[441] = new Array("彭水苗族土家族自治县","9","462");
        
subcat1[442] = new Array("贺州市","11","463");
        
subcat1[443] = new Array("来宾市","11","464");
        
subcat1[444] = new Array("崇左市","11","465");
        
subcat1[445] = new Array("眉山市","27","466");
        
subcat1[446] = new Array("资阳市","27","467");
        
subcat1[447] = new Array("玉树藏族自治州","24","468");
        
subcat1[448] = new Array("中卫市","23","469");
        
subcat1[449] = new Array("九龙","32","470");
        
subcat1[450] = new Array("新界东","32","471");
        
subcat1[451] = new Array("新界西","32","472");
        
subcat1[452] = new Array("澳门离岛","33","473");
        
subcat1[453] = new Array("新北市","34","474");
        
subcat1[454] = new Array("台中市","34","475");
        
subcat1[455] = new Array("台南市","34","476");
        
subcat1[456] = new Array("高雄市","34","477");
        
subcat1[457] = new Array("基隆市","34","478");
        
subcat1[458] = new Array("新竹市","34","479");
        
subcat1[459] = new Array("嘉义市","34","480");
        
subcat1[460] = new Array("桃园县","34","481");
        
subcat1[461] = new Array("新竹县","34","482");
        
subcat1[462] = new Array("苗栗县","34","483");
        
subcat1[463] = new Array("彰化县","34","484");
        
subcat1[464] = new Array("南投县","34","485");
        
subcat1[465] = new Array("云林县","34","486");
        
subcat1[466] = new Array("嘉义县","34","487");
        
subcat1[467] = new Array("屏东县","34","488");
        
subcat1[468] = new Array("宜兰县","34","489");
        
subcat1[469] = new Array("花莲县","34","490");
        
subcat1[470] = new Array("台东县","34","491");
        
subcat1[471] = new Array("澎湖县","34","492");
        
onecount1=472;

function changelocation1(locationid)
    {
    document.addnew.quyu_nclass_id.length = 0; 
    ...
    for (i=0;i < onecount1; i++)
        {
            ...
            { 
                document.addnew.quyu_nclass_id.options[document.addnew.quyu_nclass_id.length] = new Option(subcat1[i][0], subcat1[i][2]);
            }        
        }
   ...
   <select name="quyu_class_id" onChange="changelocation1(document.addnew.quyu_class_id.options[document.addnew.quyu_class_id.selectedIndex].value)" size="1">
...
<option value="35">国外与其它</option>
 
</select>

<select name="quyu_nclass_id">
<option value="">选择城市</option>
</select>

                                            <font color="#EC5106">*</font></td>
                                        </tr>
			 <tr> 
                                          <td width="24%" height="25" align="right">占地面积：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="占地面积" id="占地面积">
                                          </td>
                                        </tr>  
                               
                                        <tr> 
                                          <td width="24%" height="6" align="right">成立日期：</td>
                                          <td width="76%" height="6"> &nbsp; 
      <input class="Wdate" type="text" onClick="WdatePicker()" name="成立日期" id="成立日期">
                                       </td>
                                        </tr>

                                          <tr> 
                                          <td width="24%" height="6" align="right">公司标记：</td>
                                          <td width="76%" height="6"> &nbsp; 
                                            <input type="text" name="标记" id="标记">
                                           ★代表 √代表 ⊙代表 </td>
                                        </tr>
<tr> 
                                          <TD bgColor=#000000 height=2 bordercolor="#111111"> 
                                        ...
                                        <tr> 
			  <tr> 
                                          <td width="24%" align="right" height="25">公司通讯地址：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="通讯地址" id="通讯地址" size="30" maxLength=40 >
                                            <font color="#ff0033">　</font><font color="#EC5106">*</font><br>
 <font color="#666666">请填写区、街道、门牌或信箱号；如“XX路XX号”</font></td>
                                        </tr>

			<tr> 
                                          <td width="24%" align="right" height="25">邮政编码：</td>
                                          <td width="76%" height="25" style="padding-left:12px "> 
                                            <input type="text" name="邮政编码" id="邮政编码"  maxlength=6 size="7" onKeyUp="value=value.replace(/[^\d]/g,'')"/>                                           <font color="#EC5106"></font>
											<font color="#666666">请输入6位数字的邮政编码</font></td>
                                        </tr>

 <tr> 
                                          <td width="24%" align="right" height="25">公司联系电话：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="公司联系电话" id="公司联系电话"  size="20" maxLength=40 >
<asp:RegularExpressionValidator ID="v66" runat="server" ControlToValidate="这里是Textbox控件的ID" ErrorMessage="固定电话格式不正确！" ValidationExpression="^(0[0-9]{2,3}\-)?([2-9][0-9]{6,7})+(\-[0-9]{1,4})?$" ></asp:RegularExpressionValidator>
                                            <font color="#EC5106"></font> <font color="#666666">国家代码－区号－电话号码如：86-577-86062878</font></td>
                                        </tr>
<tr> 
                                          <td width="24%" height="25" align="right">所属商会：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <SELECT size=1 name=所属商会 >
                                              <OPTION value="" selected>请在以下列表中选择</OPTION>
                                              <OPTION value=温州泰顺企业家协会>温州泰顺企业家协会</OPTION>
<OPTION value=阿联酋龙城商会>阿联酋龙城商会</OPTION>
<OPTION value=阿联酋温州同乡会>阿联酋温州同乡会</OPTION>
<OPTION value=安徽六安浙江商会>安徽六安浙江商会</OPTION>
<OPTION value=安徽省服装商会>安徽省服装商会</OPTION>
<OPTION value=安徽省温州企业家联合会>安徽省温州企业家联合会</OPTION>
<OPTION value=安徽宿州浙江商会>安徽宿州浙江商会</OPTION>
<OPTION value=安徽浙江商会>安徽浙江商会</OPTION>
<OPTION value=安徽浙江商会>安徽浙江商会</OPTION>
<OPTION value=鞍山市温州商会>鞍山市温州商会</OPTION>
<OPTION value=北京泰顺商会>北京泰顺商会</OPTION>
<OPTION value=北京温州商会>北京温州商会</OPTION>
<OPTION value=北京浙江商会>北京浙江商会</OPTION>
<OPTION value=常德温州商会>常德温州商会</OPTION>
<OPTION value=常州温州商会常务>常州温州商会常务</OPTION>
<OPTION value=常州浙江商会>常州浙江商会</OPTION>
<OPTION value=滁州浙江商会>滁州浙江商会</OPTION>
<OPTION value=大理浙江商会>大理浙江商会</OPTION>
<OPTION value=大连温州商会>大连温州商会</OPTION>
<OPTION value=东方陶瓷商城商会>东方陶瓷商城商会</OPTION>
<OPTION value=东莞市温州商会>东莞市温州商会</OPTION>
<OPTION value=东阳市温州商会>东阳市温州商会</OPTION>
<OPTION value=佛山市浙江商会>佛山市浙江商会</OPTION>
<OPTION value=福建福州温州商会>福建福州温州商会</OPTION>
<OPTION value=福建南平温州商会>福建南平温州商会</OPTION>
<OPTION value=福州温州商会>福州温州商会</OPTION>
<OPTION value=固始县工商联协会>固始县工商联协会</OPTION>
<OPTION value=广西钦州市浙江商会>广西钦州市浙江商会</OPTION>
<OPTION value=广州泰顺商会>广州泰顺商会</OPTION>
<OPTION value=哈尔滨浙江商会>哈尔滨浙江商会</OPTION>
<OPTION value=哈密市温州商会>哈密市温州商会</OPTION>
<OPTION value=海安浙江商会>海安浙江商会</OPTION>
<OPTION value=杭州泰顺商会>杭州泰顺商会</OPTION>
<OPTION value=杭州温州商会>杭州温州商会</OPTION>
<OPTION value=杭州下沙石材商会>杭州下沙石材商会</OPTION>
<OPTION value=豪州温州商会>豪州温州商会</OPTION>
<OPTION value=合肥市温州商会>合肥市温州商会</OPTION>
<OPTION value=河北金融协会>河北金融协会</OPTION>
<OPTION value=河北省廊坊市温州商会>河北省廊坊市温州商会</OPTION>
<OPTION value=河北省浙江商会>河北省浙江商会</OPTION>
<OPTION value=河北浙江企业联合会>河北浙江企业联合会</OPTION>
<OPTION value=河北浙江商会>河北浙江商会</OPTION>
<OPTION value=河南洛阳市浙江商会>河南洛阳市浙江商会</OPTION>
<OPTION value=河南平顶山温州商会>河南平顶山温州商会</OPTION>
<OPTION value=荷泽浙江商会>荷泽浙江商会</OPTION>
<OPTION value=衡水市温州商会>衡水市温州商会</OPTION>
<OPTION value=湖南常德温州商会>湖南常德温州商会</OPTION>
<OPTION value=湖南浙江商会>湖南浙江商会</OPTION>
<OPTION value=湖州温州商会>湖州温州商会</OPTION>
<OPTION value=华阴市工商联>华阴市工商联</OPTION>
<OPTION value=淮安商会>淮安商会</OPTION>
<OPTION value=淮安温州商会>淮安温州商会</OPTION>
<OPTION value=黄山市温州商会>黄山市温州商会</OPTION>
<OPTION value=黄石温州商会>黄石温州商会</OPTION>
<OPTION value=惠州浙江商会>惠州浙江商会</OPTION>
<OPTION value=济南温州商会>济南温州商会</OPTION>
<OPTION value=济宁浙江商会>济宁浙江商会</OPTION>
<OPTION value=嘉兴市温州商会>嘉兴市温州商会</OPTION>
<OPTION value=建阳温州商会>建阳温州商会</OPTION>
<OPTION value=建筑协会>建筑协会</OPTION>
<OPTION value=江门浙江商会>江门浙江商会</OPTION>
<OPTION value=江苏宝应浙江商会>江苏宝应浙江商会</OPTION>
<OPTION value=江苏海安县浙江商会>江苏海安县浙江商会</OPTION>
<OPTION value=江苏南通温州商会>江苏南通温州商会</OPTION>
<OPTION value=江苏邳州浙江商会>江苏邳州浙江商会</OPTION>
<OPTION value=江苏省泰兴市浙江商会>江苏省泰兴市浙江商会</OPTION>
<OPTION value=江苏省泰州市浙江企业家联合会>江苏省泰州市浙江企业家联合会</OPTION>
<OPTION value=江苏省浙江商会>江苏省浙江商会</OPTION>
<OPTION value=江苏扬州宝应浙江同乡会>江苏扬州宝应浙江同乡会</OPTION>
<OPTION value=江苏浙江商会>江苏浙江商会</OPTION>
<OPTION value=江苏浙江商会>江苏浙江商会</OPTION>
<OPTION value=姜堰浙江商会>姜堰浙江商会</OPTION>
<OPTION value=焦作市温州商会>焦作市温州商会</OPTION>
<OPTION value=焦作市温州商会>焦作市温州商会</OPTION>
<OPTION value=金坊温州商会>金坊温州商会</OPTION>
<OPTION value=金坛市温州商会>金坛市温州商会</OPTION>
<OPTION value=靖安工商联副主席>靖安工商联副主席</OPTION>
<OPTION value=九江浙江商会>九江浙江商会</OPTION>
<OPTION value=句容市浙江商会>句容市浙江商会</OPTION>
<OPTION value=句容市浙江商会>句容市浙江商会</OPTION>
<OPTION value=句容市浙江商会>句容市浙江商会</OPTION>
<OPTION value=昆明市工商联执委>昆明市工商联执委</OPTION>
<OPTION value=昆山花桥商会>昆山花桥商会</OPTION>
<OPTION value=昆山温州商会>昆山温州商会</OPTION>
<OPTION value=昆山五金机电流通商会>昆山五金机电流通商会</OPTION>
<OPTION value=乐陵浙江商会>乐陵浙江商会</OPTION>
<OPTION value=乐山温州商会>乐山温州商会</OPTION>
<OPTION value=连云港浙江商会>连云港浙江商会</OPTION>
<OPTION value=辽宁省浙江商会>辽宁省浙江商会</OPTION>
<OPTION value=眉山市浙江商会>眉山市浙江商会</OPTION>
<OPTION value=民营经济研究会>民营经济研究会</OPTION>
<OPTION value=南昌温州商会>南昌温州商会</OPTION>
<OPTION value=南京温州商会>南京温州商会</OPTION>
<OPTION value=南宁温州商会>南宁温州商会</OPTION>
<OPTION value=南通温州商会>南通温州商会</OPTION>
<OPTION value=南通温州商会>南通温州商会</OPTION>
<OPTION value=宁德市建筑业协会>宁德市建筑业协会</OPTION>
<OPTION value=宁德温州商会>宁德温州商会</OPTION>
<OPTION value=平顶山市温州商会>平顶山市温州商会</OPTION>
<OPTION value=濮阳温州商会>濮阳温州商会</OPTION>
<OPTION value=濮阳浙江商会执行>濮阳浙江商会执行</OPTION>
<OPTION value=青岛市温州商会>青岛市温州商会</OPTION>
<OPTION value=青企协>青企协</OPTION>
<OPTION value=全国工商联五金机电商会>全国工商联五金机电商会</OPTION>
<OPTION value=全国工商联五金机电商会常务>全国工商联五金机电商会常务</OPTION>
<OPTION value=全国浙商会主席>全国浙商会主席</OPTION>
<OPTION value=日本温泉卫生管理协会中国总会>日本温泉卫生管理协会中国总会</OPTION>
<OPTION value=如皋浙江商会>如皋浙江商会</OPTION>
<OPTION value=厦门温州商会>厦门温州商会</OPTION>
<OPTION value=山东德州市温州商会>山东德州市温州商会</OPTION>
<OPTION value=山东淄博泰顺商会>山东淄博泰顺商会</OPTION>
<OPTION value=山东淄博温州商会>山东淄博温州商会</OPTION>
<OPTION value=山西浙江商会>山西浙江商会</OPTION>
<OPTION value=汕头市温州商会>汕头市温州商会</OPTION>
<OPTION value=上海女企业家协会执行>上海女企业家协会执行</OPTION>
<OPTION value=上海汽车配件用品流通商会>上海汽车配件用品流通商会</OPTION>
<OPTION value=上海市商业协会>上海市商业协会</OPTION>
<OPTION value=上海市浙江商会>上海市浙江商会</OPTION>
<OPTION value=上海泰顺商会>上海泰顺商会</OPTION>
<OPTION value=上海泰顺商会>上海泰顺商会</OPTION>
<OPTION value=上海温州商会>上海温州商会</OPTION>
<OPTION value=绍兴市温州商会>绍兴市温州商会</OPTION>
<OPTION value=深圳泰顺同乡会>深圳泰顺同乡会</OPTION>
<OPTION value=石家庄温州商会>石家庄温州商会</OPTION>
<OPTION value=世界杰出华商协会>世界杰出华商协会</OPTION>
<OPTION value=沭阳浙江商会>沭阳浙江商会</OPTION>
<OPTION value=四川南充温州商会>四川南充温州商会</OPTION>
<OPTION value=四川省温州商会>四川省温州商会</OPTION>
<OPTION value=四川浙江商会>四川浙江商会</OPTION>
<OPTION value=泗阳浙江商会>泗阳浙江商会</OPTION>
<OPTION value=苏州市房地产商会>苏州市房地产商会</OPTION>
<OPTION value=苏州市房地产商会>苏州市房地产商会</OPTION>
<OPTION value=苏州市温州商会>苏州市温州商会</OPTION>
<OPTION value=苏州市吴中区房地产商会>苏州市吴中区房地产商会</OPTION>
<OPTION value=苏州市浙江商会>苏州市浙江商会</OPTION>
<OPTION value=太仓市温州商会>太仓市温州商会</OPTION>
<OPTION value=泰顺北京商会>泰顺北京商会</OPTION>
<OPTION value=泰顺企业家联谊会>泰顺企业家联谊会</OPTION>
<OPTION value=泰顺上海商会>泰顺上海商会</OPTION>
<OPTION value=泰州商会>泰州商会</OPTION>
<OPTION value=泰州浙江企业家联合会>泰州浙江企业家联合会</OPTION>
<OPTION value=泰州浙江商会>泰州浙江商会</OPTION>
<OPTION value=通辽市浙江商会>通辽市浙江商会</OPTION>
<OPTION value=桐乡温州商会>桐乡温州商会</OPTION>
<OPTION value=铜川市浙苏商会<OPTION value=铜川市浙苏商会</OPTION>
<OPTION value=潍坊温州商会>潍坊温州商会</OPTION>
<OPTION value=温岭鞋业商会>温岭鞋业商会</OPTION>
<OPTION value=温台商会>温台商会</OPTION>
<OPTION value=温州商会>温州商会</OPTION>
<OPTION value=温州市市场营销协会>温州市市场营销协会</OPTION>
<OPTION value=温州市泰商发展联合会>温州市泰商发展联合会</OPTION>
<OPTION value=温州泰商联合会>温州泰商联合会</OPTION>
<OPTION value=温州泰顺商会>温州泰顺商会</OPTION>
<OPTION value=文泰商会>文泰商会</OPTION>
<OPTION value=无锡滨湖房地产商会>无锡滨湖房地产商会</OPTION>
<OPTION value=无锡温州商会会员>无锡温州商会会员</OPTION>
<OPTION value=无锡总商会温州商会>无锡总商会温州商会</OPTION>
<OPTION value=吴江市装饰建材协会>吴江市装饰建材协会</OPTION>
<OPTION value=武陵区工商联>武陵区工商联</OPTION>
<OPTION value=下沙石材商会>下沙石材商会</OPTION>
<OPTION value=襄樊市浙江温商会>襄樊市浙江温商会</OPTION>
<OPTION value=襄樊温州商会>襄樊温州商会</OPTION>
<OPTION value=新疆浙江企业联合会>新疆浙江企业联合会</OPTION>
<OPTION value=宿迁市装饰建材商会>宿迁市装饰建材商会</OPTION>
<OPTION value=宿迁浙江商会>宿迁浙江商会</OPTION>
<OPTION value=宿迁浙江总商会>宿迁浙江总商会</OPTION>
<OPTION value=宿州浙江商会>>宿州浙江商会></OPTION>
<OPTION value=徐州温州商会>徐州温州商会</OPTION>
<OPTION value=宣城浙江商会>宣城浙江商会</OPTION>
<OPTION value=雅阳教育基金会>雅阳教育基金会</OPTION>
<OPTION value=盐城市工商联>盐城市工商联</OPTION>
<OPTION value=盐城市浙江商会>盐城市浙江商会</OPTION>
<OPTION value=扬州市高邮市浙江商会>扬州市高邮市浙江商会</OPTION>
<OPTION value=阳江市工商联副主席>阳江市工商联副主席</OPTION>
<OPTION value=阳江总商会>阳江总商会</OPTION>
<OPTION value=义乌泰顺商会>义乌泰顺商会</OPTION>
<OPTION value=永州浙江商会>永州浙江商会</OPTION>
<OPTION value=余杭区温台商会>余杭区温台商会</OPTION>
<OPTION value=云南省工商联代表>云南省工商联代表</OPTION>
<OPTION value=云南温州商会>云南温州商会</OPTION>
<OPTION value=张家港浙江商会>张家港浙江商会</OPTION>
<OPTION value=漳州温州商会>漳州温州商会</OPTION>
<OPTION value=长沙温州商会>长沙温州商会</OPTION>
<OPTION value=浙江商会>浙江商会</OPTION>
<OPTION value=浙江省民营经济研究会>浙江省民营经济研究会</OPTION>
<OPTION value=浙江省少数民族企业家协会>浙江省少数民族企业家协会</OPTION>
<OPTION value=浙江省书法家协会学术委员会>浙江省书法家协会学术委员会</OPTION>
<OPTION value=浙商全国会主席团主席>>浙商全国会主席团主席></OPTION>
<OPTION value=浙商全国市场联合会>浙商全国市场联合会</OPTION>
<OPTION value=浙商研究会>浙商研究会</OPTION>
<OPTION value=镇江市温州商会>镇江市温州商会</OPTION>
<OPTION value=镇雄温州商会>镇雄温州商会</OPTION>
<OPTION value=郑州温州商会>郑州温州商会</OPTION>
<OPTION value=中国建材家居交易市场协会>中国建材家居交易市场协会</OPTION>
<OPTION value=中国建筑卫生陶瓷协会>中国建筑卫生陶瓷协会</OPTION>
<OPTION value=中国卤制品协作>中国卤制品协作</OPTION>
<OPTION value=中国民营企业家协会>中国民营企业家协会</OPTION>
<OPTION value=中国西部研究与发展促进会>中国西部研究与发展促进会</OPTION>
<OPTION value=中商联市场委副主任>中商联市场委副主任</OPTION>
<OPTION value=重庆市总商会浙江商会>重庆市总商会浙江商会</OPTION>
<OPTION value=重庆浙江商会>重庆浙江商会</OPTION>
<OPTION value=洲泉足佳皮革协会>洲泉足佳皮革协会</OPTION>
<OPTION value=熹文化协会>朱熹文化协会</OPTION>
<OPTION value=遵义温州商会>遵义温州商会</OPTION>	
                                            </SELECT>
                                            <font color="#EC5106"></font> 
                                          </td>
                                        </tr>
 <tr> 
                                          <td width="24%" align="right" height="25">贵公司网址：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="网址" type="text" id="网址" value="http://" size="20" maxlength=40>
                                           <font color="#666666">网址必须以http://打头如：http://www.wzsrw.cn</font></td>
                                        </tr>
                                  ...
                                  <div align="center"> 
                                    <center>
                                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber122" bgcolor="#F5F5F5" height="25">
                                        ...
                                        <tr> 
                                          <td width="24%" align="right" height="25">主负责人：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="主负责人" id="主负责人"onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')" >
                                            <font color="#EC5106">*</font><font color="#666666">请填写正确的姓名,只允许填写中文字符!</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">主负责人手机：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人手机" type="text" id="主负责人手机" maxLength=40 >
											<font color="#666666"><br>
											建议您填写，以便潜在客户及时与您取得联系！<br>
                                            温州商人网不绑定任何收费服务！</font>
                                          </td>
                                        </tr>
 <tr> 
                                          <td width="24%" align="right" height="25">主负责人性别：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人性别" type="text" id="主负责人性别" maxLength=40 >
											
                                          </td>
                                        </tr>
<tr> 
                                          <td width="24%" align="right" height="25">主负责人住址：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="主负责人住址" id="主负责人住址" size="30" maxLength=40 >
                                            <font color="#ff0033">　<br>
 <font color="#666666">请填写省、市、区、街道、门牌或信箱号；如“XX省XX市XX路XX号”</font></td>
                                        </tr>
<tr> 
                                          <td width="24%" align="right" height="25">主负责人所在区域邮编：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人邮编" type="text" id="主负责人邮编" maxLength=40 >
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="主负责人籍贯" id="主负责人籍贯" size="30" maxLength=40 >
                                            <font color="#ff0033">　<br>
			</td>
                                        </tr>
<tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="主负责人商会职务" type="text" id="主负责人商会职务" size="12" maxLength=40> 
			<font color="#666666"><br>请填如名誉会长，会长,副会长，常务副会长，秘书长，会员等<br>
                                       </font>
                                          </td>
                                        </tr>

										 <tr> 
                                          <td width="24%" align="right" height="25">主负责人商务QQ：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="zqq" type="text" id="zqq" size="12" maxLength=40> 
                                            <font color="#666666"> 5-11位的数字，请正确填写你的常用QQ，方便客户与您在线交谈！</font>
                                          </td>
                                        </tr>
										<tr> 

										 <tr> 
                                          <td width="24%" align="right" height="25">主负责人身份证：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="主负责人身份证" type="text" id="主负责人身份证" size="12" maxLength=40 > 
                                          </td>
                                        </tr>
			<tr> 

										 <tr> 
                                          <td width="24%" align="right" height="25">主负责人工作职务：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="主负责人工作职务" type="text" id="主负责人工作职务" size="12" maxLength=40 > 
                                          </td>
                                        </tr>							
                                        
                                        <tr> 
                                          <td width="24%" align="right" height="25">主负责人传真：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="主负责人传真" id="主负责人传真" size="20" maxLength=40 >
                                            <font color="#666666">国家代码－区号－传真号码</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">主负责人邮箱：</td>
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input type="text" name="email" id="email" size="20" maxLength=40 >
                                            <font color="#ff0033">　</font><font color="#666666">请填写常用的电子邮箱，这也是客户联系您的首选方式！</font></td>
                                        </tr>
         ...
         <div align="center"> 
                                  ...
                                  <div align="center"> 
                                    <center>
                                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber122" bgcolor="#F5F5F5" height="25">
                                        <tr> 
                                          <td width="24%" align="right" height="25">副负责人：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="副负责人" id="副负责人" maxLength=40 onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')">
                                            <font color="#666666">请填写正确的姓名,只允许填写中文字符!</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">副负责人手机：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责人手机" type="text" id="副负责人手机" maxLength=40 >
											<font color="#666666"><br>
											建议您填写，以便潜在客户及时与您取得联系！<br>
                                            温州商人网不绑定任何收费服务！</font>
                                          </td>
 ...
 <tr> 
                                          <td width="24%" align="right" height="25">副负责人性别：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责人性别" type="text" id="副负责人性别" maxLength=40 onKeyUp="value=value.replace(/[^\d]/g,'')"/>
											
                                          </td>
                                        </tr>
 <tr> 
           <td width="24%" align="right" height="25">副负责人住址：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="副负责人住址" id="副负责人住址" size="30" maxLength=40 >
                                            <font color="#ff0033">　<br>
 <font color="#666666">请填写省、市、区、街道、门牌或信箱号；如“XX省XX市XX路XX号”</font></td>
                                        </tr>
<tr> 
                                          <td width="24%" align="right" height="25">副负责人所在区域邮编：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责人邮编" type="text" id="副负责人邮编" maxLength=40 >
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="副负责人籍贯" id="副负责人籍贯" size="30" maxLength=40 >
                                            <font color="#ff0033">　<br>
			</td>
                                        </tr>
<tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="副负责人商会职务" type="text" id="副负责人商会职务" size="12" maxLength=40> 
			<font color="#666666"><br>请填如名誉会长，会长,副会长，常务副会长，秘书长，会员等<br>
                                       </font>
                                          </td>
 </tr>
                                          <td width="24%" align="right" height="25">副负责人商务QQ：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="fqq" type="text" id="fqq" size="12" maxLength=40 > 
                                            <font color="#666666"> 5-11位的数字，请正确填写你的常用QQ，方便客户与您在线交谈！</font>
                                          </td>
                                        </tr>
										<tr> 
										 ...
										 <tr> 
                                          <td width="24%" align="right" height="25">副负责人身份证：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="副负责人身份证" type="text" id="副负责人身份证" size="12" maxLength=40 > 
                                          </td>
                                        </tr>
			<tr> 
                                          <td width="24%" align="right" height="25">副负责人工作职务：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="副负责人工作职务" type="text" id="副负责人工作职务" size="12" maxLength=40 > 
                                          </td>
                                        </tr>														
                                        
                                        <tr> 
                                          <td width="24%" align="right" height="25">副负责人传真：</td>
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="副负责人传真" id="副负责人传真" size="20" maxLength=40 >
                                            <font color="#666666">国家代码－区号－传真号码</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">副负责人邮箱：</td>
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input type="text" name="email" id="email" size="20" maxLength=40 >
                                            <font color="#ff0033">　</font><font color="#666666">请填写常用的电子邮箱，这也是客户联系您的首选方式！</font></td>
                                        </tr>
										 ...
										 <TR style="display:none "> 
                                                <TD width="24%" height=30> <P align="right" style="LINE-HEIGHT: 200%">反群发必填项：&nbsp;</P></TD>
                                                <TD width="76%" height=30>&nbsp;中国最长的河流叫什么名字？ = <input size=10 name=evilanswer> <br>
(为了防止群发软件的恶意注册，请回答问题。)<font color="#EC5106">*</font> </TD>
										 </TR>
										  <TR> 
