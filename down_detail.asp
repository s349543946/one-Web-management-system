...
<div id="contain">
  ...
  <div id="dc">
    ...
    <div class="dc_r">
      <div class="dc_r_t"><div class="title">当前位置：<a href="index.html" target="_self">网站首页</a> > 信息详细</div></div>
      <div class="dc_r_c">
        <div class="dc_r_c_c">
          ...
          <div class="show">
           <%=rs("body")%>
            ...
            <div class="down"><a href="<%=rs("url")%>" target="_self"><img src="images/down.gif" /></a></div>
            <% rs.close
		set rs=nothing
		%>
          </div>
