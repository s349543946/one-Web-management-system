...
cs=request.Form("quyu_nclass_id")
if cs<>"" then
...
dsql1="select * from company_info where 公司名称 ='"&request.Form("公司名称")&"' "
set rs=server.createobject("adodb.recordset")
