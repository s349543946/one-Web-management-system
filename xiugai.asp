...
sql="select * from company_info where company_id="&request.form("id")&" and ((主负责人籍贯 like '%"&xz&"%')or(副负责人籍贯 like '%"&xz&"%') ) "
   rs.open sql,conn,1,1 
msg="注册错误信息："
if rs("公司名称")="" then
msg=msg&"<br>"&"*此企业不属于该商会"
end if
if strcomp(msg,"注册错误信息：")>0 then
response.Redirect("search修改.asp?msg=" & msg)
end if
...
if qx="2" then
   set rs=server.createobject("adodb.recordset") 
sql="select * from company_info where company_id="&request.form("id")&" and 所属商会 = '"&sh&"' "
   rs.open sql,conn,1,1 
msg="注册错误信息："
if rs("公司名称")="" then
msg=msg&"<br>"&"*此企业不属于该商会"
...
if qx="1" then
   set rs=server.createobject("adodb.recordset") 
sql="select * from company_info where company_id="&request.form("id")&"  "
   rs.open sql,conn,1,1 
end if
...
sql="select * from wenshangxinxi where ID="&rs("主负责人")&""
rsc7.open sql,conn,1,1

set rsc8=server.createobject("adodb.recordset")
sql="select * from wenshangxinxi where ID="&rs("副负责人")&""
...
<script type="text/javascript" src="My97DatePicker/WdatePicker.js" value=<%=rs("成立日期")%>> </script>
                              ...
                              <TBODY>
                                <TR> 
                                  <TD width="100%" height=30> <P align=center>+++ 
                                      企业信息修改 +++  <font color="#EC5106">(*必填)</font></P></TD>
                                </TR>
...
//-->
                                      ...
                                      <CENTER>
   <FORM name=addnew onSubmit="return checkform();" action="addnewdatagai.asp?ac=adduser" method=post>
									  ...
									  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber116" bgcolor="#F5F5F5">
                                        <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input name="公司名称" type="text"  size="30" value=<%=rs("公司名称")%>>  
...
<select name="tradeid"  onChange="changelocation(document.addnew.tradeid.options[document.addnew.tradeid.selectedIndex].value)" size="1">
 <option value="" selected ><%=rs("行业大类")%></option>
    ...
    <option value=""><%=rs("行业小类")%></option>
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <SELECT size=1 name=企业性质 >
                                              <OPTION value="" selected><%=rs("企业性质")%></OPTION>
			    			...
			    			<OPTION value=股份制企业 >股份制企业</OPTION>                                  
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="注册资金" id="注册资金" value=<%=rs("注册资金(万元)")%>>
                                            万人民币</td>
                                        </tr>
...
<option value=""><%=rs("城市")%></option>
			 ...
			 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="占地面积" id="占地面积" value=<%=rs("占地面积")%>>
                                          </td>
                                        </tr>  
      ...
      <input class="Wdate" type="text"  onClick="WdatePicker()" name="成立日期" id="成立日期" value=<%=rs("成立日期")%> >
                                       </td>
                                        </tr>
...
<tr> 
			  ...
			  <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="通讯地址" id="通讯地址"  size="30" maxLength=40 value=<%=rs("通讯地址")%>>
 ...
 <font color="#666666">请填写区、街道、门牌或信箱号；如“XX路XX号”</font></td>
			...
			<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px "> 
                                            <input type="text" name="邮政编码" id="邮政编码" maxlength=6 size="7" onKeyUp="value=value.replace(/[^\d]/g,'')"/ value=<%=rs("邮政编码")%> >                                           <font color="#EC5106"></font>
 ...
 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="公司联系电话" id="公司联系电话"  size="20" maxLength=40 value=<%=rs("公司联系电话")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <SELECT size=1 name=所属商会 >
                                              <OPTION value="" selected><%=rs("所属商会")%></OPTION>
<%
...
%>
 ...
 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="网址" type="text" id="网址"  size="20" maxlength=40 value=<%=rs("网址")%>>
                                    ...
                                    <center>
                                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber122" bgcolor="#F5F5F5" height="25">
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="主负责人" id="主负责人"  onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')" value=<%=rsc7("姓名")%>>
                                            <font color="#EC5106">*</font><font color="#666666">请填写正确的姓名,只允许填写中文字符!</font></td>
                                        </tr>
<tr> 
                                          <td width="24%" align="right" height="25">主负责人是否是名人：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责是否是名人" type="text" id="主负责人是否是名人" maxLength=40 value=<%=rsc7("是否是名人")%>>
											 <font color="#EC5106">*</font><font color="#666666"><br>
										建议填写是或否！<br></font>
                                          </td>
                                        </tr>
                                        <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人手机" type="text" id="主负责人手机" maxLength=40 value=<%=rsc7("手机")%>>
											<font color="#666666"><br>
											建议您填写，以便潜在客户及时与您取得联系！<br></font>
                                          </td>
                                        </tr>
 <tr> 
                                          <td width="24%" align="right" height="25">主负责人性别：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人性别" type="text" id="主负责人性别" maxLength=40 value=<%=rsc7("性别")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="主负责人住址" id="主负责人住址" size="30" maxLength=40 value=<%=rsc7("所在区域")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人邮编" type="text" id="主负责人邮编" maxLength=40 value=<%=rsc7("邮编")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="主负责人籍贯" id="主负责人籍贯" size="30" maxLength=40 value=<%=rsc7("籍贯")%>>
                                            <font color="#ff0033">　<br>
			</td>
                                        </tr>
...
<tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="主负责人商会职务" type="text" id="主负责人商会职务" size="12" > 
			<font color="#666666"><br>职务未变化请不要填写 请填如会长,常务副会长，秘书长，副秘书长，会员等 <br>
                                       </font>
                                          </td>
                                        </tr>
										 ...
										 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="zqq" type="text" id="zqq" size="12" maxLength=40 value=<%=rsc7("qq")%>> 
										...
										<tr> 
										 ...
										 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="主负责人身份证" type="text" id="主负责人身份证" size="12" maxLength=40 value=<%=rsc7("身份证")%>> 
                                          </td>
                                        </tr>
			<tr> 
...
<font color="#666666"><br>职务未变化请不要填写 <br>
                                       </font>
                                          </td>
                                        </tr>							
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="主负责人传真" id="主负责人传真" size="20" maxLength=40 value=<%=rsc7("传真")%>>
                                            <font color="#666666">国家代码－区号－传真号码</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">主负责人邮箱：</td>
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input type="text" name="email" id="email" size="20" maxLength=40 value=<%=rsc7("邮箱")%>>
                                    ...
                                    <center>
                                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber122" bgcolor="#F5F5F5" height="25">
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="副负责人" id="副负责人"  onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')" value=<%=rsc8("姓名")%> >
                                            <font color="#666666">请填写正确的姓名,只允许填写中文字符!</font></td>
                                        </tr>
<tr> 
                                          <td width="24%" align="right" height="25">副负责人是否是名人：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责是否是名人" type="text" id="副负责人是否是名人" maxLength=40 value=<%=rsc8("是否是名人")%>>
											<font color="#666666"><br>
										建议填写是或否！<br></font>
                                          </td>
                                        </tr>
                                        <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责人手机" type="text" id="副负责人手机" maxLength=40 value=<%=rsc8("手机")%>>
											<font color="#666666"><br>
											建议您填写，以便潜在客户及时与您取得联系！<br></font>
                                          </td>
                                        </tr>
 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责人性别" type="text" id="副负责人性别" maxLength=40 onKeyUp="value=value.replace(/[^\d]/g,'')"/ value=<%=rsc8("性别")%>>
 ...
 <tr> 
           <td width="24%" align="right" height="25">副负责人住址：</td>
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="副负责人住址" id="副负责人住址" size="30" maxLength=40 value=<%=rsc8("所在区域")%>>
                                            <font color="#ff0033">　<br>
 <font color="#666666">请填写省、市、区、街道、门牌或信箱号；如“XX省XX市XX路XX号”</font></td>
                                        </tr>
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责人邮编" type="text" id="副负责人邮编" maxLength=40 value=<%=rsc8("邮编")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="副负责人籍贯" id="副负责人籍贯" size="30" maxLength=40 value=<%=rsc8("籍贯")%>>
                                            <font color="#ff0033">　<br>
			</td>
                                        </tr>
...
<tr> 
			...
			<font color="#666666"><br>职务未变化请不要填写！ 请填如会长,常务副会长，秘书长，副秘书长，会员等<br>
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="fqq" type="text" id="fqq" size="12" maxLength=40 value=<%=rsc8("qq")%>> 
                                            <font color="#666666"> 5-11位的数字，请正确填写你的常用QQ，方便客户与您在线交谈！</font>
                                          </td>
                                        </tr>
										<tr> 
										 ...
										 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="副负责人身份证" type="text" id="副负责人身份证" size="12" maxLength=40 value=<%=rsc8("身份证")%>> 
                                          </td>
                                        </tr>
			<tr> 
...
<font color="#666666"><br>职务未变化请不要填写 <br>
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="副负责人传真" id="副负责人传真" size="20" maxLength=40 value=<%=rsc8("传真")%>>
                                            <font color="#666666">国家代码－区号－传真号码</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="24%" align="right" height="25">副负责人邮箱：</td>
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input type="text" name="email" id="email" size="20" maxLength=40 value=<%=rsc8("邮箱")%>>
                                            <font color="#ff0033">　</font><font color="#666666">请填写常用的电子邮箱，这也是客户联系您的首选方式！</font></td>
                                        </tr>
