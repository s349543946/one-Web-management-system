...
exec=exec+"and 成立日期 >="&"#"&CDate(qny)&"#  and 成立日期 <= #"&CDate(zny)&"# "
...
exec=exec+" where 成立日期 >="&"#"&CDate(qny)&"#  and 成立日期 <= #"&CDate(zny)&"# "
...
<p align="center"><br> 
"统计查询共有<% Response.Write(zzj) %>亿元</p><br>
<body bgcolor="#ffffff"> 
<p align="center">
<form name="form1" method="get" action="searchsh时间段资金.asp">
起始年<input type="text" name="起始年" id="起始年" size="20" value="<%=qn%>"> 年
起始月<input type="text" name="起始月" id="起始月" size="20" value="<%=qy%>">  月
终止年<input type="text" name="终止年" id="终止年" size="20" value="<%=zn%>"> 年
终止月<input type="text" name="终止月" id="终止月" size="20" value="<%=zy%>">  月   
