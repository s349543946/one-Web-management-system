...
//-->
								  ...
								  <table width="94%" height="25" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#BDBFC8" bgcolor="#F5F5F5" id="AutoNumber122" style="border-collapse: collapse">
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="商会名称" id="商会名称" maxlength=30 size="25" >  <font color="#EC5106">*</font><br>
</td>
                                        </tr>
										 <tr> 
                                          <td width="24%" align="right" height="25">会长：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="会长" id="会长"  maxlength=30 size="25" >
 ...
 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="名誉会长" id="名誉会长"  maxlength=30 size="25" >
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="副会长" id="副会长"  maxlength=30 size="25" >
  					 ...
  					 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="常务副会长" id="常务副会长"  maxlength=30 size="25" >
                                         ...
                                         <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="秘书长" id="秘书长"  maxlength=30 size="25" >
                                         ...
                                         <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="password" name="副秘书长" id="副秘书长"  maxlength=30 size="25" >
