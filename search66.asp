...
<body bgcolor="#ffffff"> 
<p align="center">
<form name="form1" method="post" action="searchsh.asp">
企业名称<input type="text" name="公司名称" id="公司名称" size="30"> 
企业类型<input type="text" name="企业类型" id="企业类型" size="30"> 
<input type="submit" name="submit" value="搜索" >
</form> 
<form name="form1" method="post" action="xiugai.asp"> 请输入要修改的记录的ID： <input type="text" name="id">  
