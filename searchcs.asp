...
jg="三魁"
exec=" select * from company_info  where 主负责人 in (select CInt(ID) from wenshangxinxi where 籍贯 like '%"&jg&"%') or 副负责人 in (select CInt(ID) from wenshangxinxi where 籍贯 like '%"&jg&"%')ORDER BY company_id  "
