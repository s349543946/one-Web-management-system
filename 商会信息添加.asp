...
//-->
                                      ...
                                      <CENTER>
   <FORM name=addnew onSubmit="return checkform();" action="addnewdatash.asp?ac=adduser" method=post >
								  ...
								  <table width="94%" height="25" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#BDBFC8" bgcolor="#F5F5F5" id="AutoNumber122" style="border-collapse: collapse">
                                       ...
                                       <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="商会名称" id="商会名称"  maxlength=30 size="25" >
                                  <front>*</front>
                                           </td>
                                        </tr>
										 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="会长" id="会长"  maxlength=30 size="25" >
 							 ...
 							 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="会长电话" id="会长电话"  maxlength=30 size="25" >
  					 ...
  					 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="常务副会长" id="常务副会长"  maxlength=30 size="25" >
			 ...
			 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="常务副会长电话" id="常务副会长电话"  maxlength=30 size="25" >
                                         ...
                                         <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="秘书长" id="秘书长"  maxlength=30 size="25" >
			 ...
			 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="秘书长电话" id="秘书长电话"  maxlength=30 size="25" >
                                         ...
                                         <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="副秘书长" id="副秘书长"  maxlength=30 size="25" >
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="副秘书长电话" id="副秘书长电话"  maxlength=30 size="25" >
    ...
    <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="是否有党组" id="是否有党组"  maxlength=30 size="25" >
                    ...
                    <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="商会地址" id="商会地址"  maxlength=30 size="25" >
