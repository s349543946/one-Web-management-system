...
elseif qx="3" then
	...
	xz=trim(xz)
	if  xz<>"" then	
		exec=exec+"where ((主负责人籍贯 like '%"&xz&"%')or(副负责人籍贯 like '%"&xz&"%') )"
	end if
...
起始年<input type="text" name="起始年" id="起始年" size="20"> 年
起始月<input type="text" name="起始月" id="起始月" size="20">  月
终止年<input type="text" name="终止年" id="终止年" size="20"> 年
终止月<input type="text" name="终止月" id="终止月" size="20">  月 
