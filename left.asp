...
<table width="185" height="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <td width="91%"><a  href="../admin_manage.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">账号管理</a>
...
<%end if%>
  ...
  <tr>
                ...
                <td width="91%"> <%if qx="3" then %><a href="../search查询.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">乡镇企业查询</a></td>
                <%else %><a  href="../search查询.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">泰商企业查询</a></td>
<%end if%>
              </tr>
  <tr>
               <%if qx<>"3" then %> <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="8" /></td>
                <td width="91%"><a href="../search籍贯查询.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">泰商籍贯查询</a></td>
                <%end if%>
              </tr>
  <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="8" /></td>
                <td width="91%"><a href="../search时间段资金.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">时间段内企业查询</a></td>
              </tr>
  <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="8" /></td>
                <td width="91%"><a href="../search温商名下查询.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">泰商名下企业查询</a></td>
              </tr>
<tr>
                <td width="9%" height="24" ><img id="xy_xt5" src="images/ico06.gif" width="8" height="8" /></td>
 <td width="91%"> <%if qx="1" then %><a  href="../add_common.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">泰商名下企业添加</a>
<%else %><a  href="../add_commonsh1.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">泰商名下企业添加</a>

<%end if%>
              <tr>         
                <td width="9%" height="24" ><img id="xy_xt2" src="images/ico06.gif" width="8" height="8" /></td>
                <td width="91%"> <a  href="../search修改.asp "  target="main" class="menu_t2" onClick="xy_tp('2');">泰商企业修改</a></td>
              </tr>
   </tr>
                       <tr>
                <td width="9%" height="24" > <%if qx="1" then %><img id="xy_xt5" src="images/ico06.gif" width="8" height="8" /></td>
 <td width="91%"><a  href="../shanghuiliulan.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">商会信息浏览</a>

<%end if%>
   </tr>     
                       <tr>
                <td width="9%" height="24" > <%if qx="1" then %><img id="xy_xt5" src="images/ico06.gif" width="8" height="8" /></td>
 <td width="91%"><a  href="../xiugaishanghuigl.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">商会信息修改</a>
...
<%end if%>
  ...
  <tr>
                <td width="9%" height="24" > <%if qx="1" then %><img id="xy_xt5" src="images/ico06.gif" width="8" height="8" /></td>
 <td width="91%"><a  href="../乡镇信息浏览.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">乡镇信息浏览</a>
