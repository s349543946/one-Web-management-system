    ...
    <td valign="top"><table width="171" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="l_tab1">
            ...
            <table id="subtree1" style="DISPLAY: none" width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="12" /></td>
                <td width="91%"><a href="../search浏览.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">信息浏览</a></td>
              </tr>
       <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="12" /></td>
                <td width="91%"><a href="../search导出.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">信息全部导出</a></td>
              </tr>
       <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="12" /></td>
                <td width="91%"><a href="../search打印.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">信息全部打印</a></td>
              </tr>
  <tr>
                <td width="9%" height="24" ><img id="xy_xt1" src="images/ico06.gif" width="8" height="12" /></td>
                <td width="91%"><a href="../search查询.asp "  target="main" class="menu_t2" onClick="xy_tp('1');">信息查询</a></td>
              </tr>
              <tr>         
                <td width="9%" height="24" ><img id="xy_xt2" src="images/ico06.gif" width="8" height="12" /></td>
                <td width="91%"> <a  href="../search修改.asp "  target="main" class="menu_t2" onClick="xy_tp('2');">信息修改</a>
...
<%end if%>
                       ...
                       <tr>
                <td width="9%" height="24" ><img id="xy_xt5" src="images/ico06.gif" width="8" height="12" /></td>
 <td width="91%"> <%if qx="1" then %><a  href="../商会信息添加.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">商会信息添加</a>

<%end if%>
   </tr>
                       <tr>
                <td width="9%" height="24" ><img id="xy_xt5" src="images/ico06.gif" width="8" height="12" /></td>
 <td width="91%"> <%if qx="1" then %><a  href="../商会信息删除.asp "  target="main" class="menu_t2" onClick="xy_tp('5');">商会信息删除</a>
...
<%end if%>
  ...
  <tr>
    <td height="20" background="images/main_58.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="20" valign="bottom"><div align="center" class="l_copy">版本：2008-2013</div></td>
        </tr>
      </table></td>
  </tr>
</table>
