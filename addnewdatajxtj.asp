...
msg=msg&"<br>"&"*主负责人是否是名人不能为空1"
end if
if strcomp(msg,"注册错误信息：")>0 then
response.Redirect("add_common.asp?msg=" & msg)
end if
if ac="adduser" then
...
rs("是否是名人")=request.Form("副负责人是否是名人")
...
sql2="select * from wenshangxinxi where 姓名='"&request.Form("主负责人")&"'"
...
<DIV align=center> 
 ...
 <script language = "JavaScript">
function send1(){ 
document.addnew.action="addnewdatajxtj.asp?ac=adduser";
document.addnew.submit();
}
function send2(){
document.addnew.action="addnewdata66.asp?ac=adduser";
document.addnew.submit(); 
}
</script>
                                      ...
                                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber122" bgcolor="#F5F5F5" height="25">
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="主负责人" id="主负责人"onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')" value=<%=rs2("姓名")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人是否是名人" type="text" id="主负责人是否是名人" maxLength=40 value=<%=rs2("是否是名人")%>>>
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人手机" type="text" id="主负责人手机" maxLength=40 value=<%=rs2("手机")%>>
 ...
 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人性别" type="text" id="主负责人性别" maxLength=40 value=<%=rs2("性别")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="主负责人住址" id="主负责人住址" size="30" maxLength=40 value=<%=rs2("住址")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人邮编" type="text" id="主负责人邮编" maxLength=40 value=<%=rs2("邮编")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input type="text" name="主负责人籍贯" id="主负责人籍贯" size="30" maxLength=40 value=<%=jg1%>>
                                            <font color="#ff0033">　<br>
			</td>
                                        </tr>
<tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="主负责人商会职务" type="text" id="主负责人商会职务" size="12" maxLength=40 value=<%=rs2("商会职务")%>> 
			<font color="#666666"><br>请填如会长，常务副会长，秘书长，副秘书长，会员等<br>
                                       </font>
                                          </td>
                                        </tr>
										 ...
										 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="zqq" type="text" id="zqq" size="12" maxLength=40 value=<%=rs2("qq")%>> 
										...
										<tr> 
										 ...
										 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="主负责人身份证" type="text" id="主负责人身份证" size="12" maxLength=40 value=<%=rs2("身份证")%>> 
                                          </td>
                                        </tr>
			<tr> 
										 ...
										 <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input name="主负责人工作职务" type="text" id="主负责人工作职务" size="12" maxLength=40 value=<%=rs2("工作职务")%>> 
                                          </td>
                                        </tr>							
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="主负责人传真" id="主负责人传真" size="20" maxLength=40 value=<%=rs2("传真")%>>
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:10px "> 
                                            <input type="text" name="email" id="email" size="20" maxLength=40 value=<%=rs2("邮箱")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <SELECT size=1 name=所属商会 >
                                              <OPTION value="" selected>请在下面列表选择</OPTION>
<%
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责人是否是名人" type="text" id="副负责人是否是名人" maxLength=40 >
											<font color="#666666"><br>
										建议填写是或否！<br></font>
                                          </td>
                                        </tr>
...
<a href="#"  onClick="javascript:show();"class="black">点此阅读泰顺商人网服务条款</a></font>
				...
				%></td>	
                                                <TD height=30 colspan="2"> <P align=center> 
       							<INPUT  type="button" name="submit1" value=" 该温商名下还有其它企业提交 " onclick="send1();">
                                                    <INPUT  type="button" name="submit2" value=" 该温商名下无其它企业提交 " onclick="send2();">
                                                    <BR>
                                                  </P></TD>
                                        </TR>
                                      </table>
