...
//-->
                                      ...
                                      <CENTER>
   <FORM name=addnew onSubmit="return checkform();" action="addnewdata66sh.asp?ac=adduser" method=post>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责是否是名人" type="text" id="主负责人是否是名人" maxLength=40 >
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责是否是名人" type="text" id="副负责人是否是名人" maxLength=40 >
											<font color="#666666"><br>
										建议填写是或否！<br></font>
                                          </td>
                                        </tr>
