...
str=trim(request("公司名称"))
str1=trim(request("企业类型"))
rm=trim(request("企业负责人"))
sf=trim(request("省份"))
cs=trim(request("城市"))
...
exec="select * from company_info where ((主负责人籍贯 like '%"&xz&"%')or(副负责人籍贯 like '%"&xz&"%') )"
 
if str<>"" then
exec=exec+"and 公司名称 like '%"&str&"%'"
end if

if str1<>"" then
exec=exec+"and (行业大类  like '%"&str1&"%' or 行业小类  like '%"&str1&"%')"
end if

if sf<>"" then
exec=exec+"and 省份 like '%"&sf&"%'"
end if

if renm<>"" then
exec=exec+"and (主负责人  = '"&renm&"' or 副负责人= '"&renm&"' )"
end if

if cs<>"" then
exec=exec+"and 城市 like '%"&cs&"%'"
end if
...
if bj="0" then
exec=exec+"and (行业大类  like '%"&str1&"%' or 行业小类  like '%"&str1&"%')"
else exec=exec+"where (行业大类  like '%"&str1&"%' or 行业小类  like '%"&str1&"%')"
bj="0"
end if
end if
...
if bj="0" then
exec=exec+"and (主负责人  = '"&renm&"' or 副负责人= '"&renm&"'  )"
else exec=exec+"where (主负责人  = '"&renm&"' or 副负责人= '"&renm&"'  )"
bj="0"
end if
end if
...
if bj="0" then
exec=exec+"and 省份 like '%"&sf&"%'"
else exec=exec+" where 省份 like '%"&sf&"%'"
bj="0"
end if
end if
...
if bj="0" then
exec=exec+"and 城市 like '%"&cs&"%'"
else exec=exec+"  where 城市 like '%"&cs&"%'"
bj="0"
end if
...
企业名称<input type="text" name="公司名称" id="公司名称" size="20" value="<%=str%>" > 
企业类型<input type="text" name="企业类型" id="企业类型" size="20" value="<%=str1%>" > 
企业负责人<input type="text" name="企业负责人" id="企业负责人" size="20" value="<%=rm%>" >
省份<input type="text" name="省份" id="省份" size="20" value="<%=sf%>">
城市<input type="text" name="城市" id="城市" size="20" value="<%=cs%>">
