          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[网站服务器运行环境信息查看]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="5%"><div align="center"><img src="images/tb.gif" width="16" height="16" /></div></td>
                <td width="95%"><span class="STYLE3">你当前的位置</span>：[网站版权信息]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
      ...
      <tr>
        ...
        <td>
          <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
              <td width="11%" class="td">网站版权所有：</td>
              <td width="89%" class="td">鑫跃科技</td>
            </tr>
            <tr>
              <td class="td">源码技术支持：</td>
              <td class="td">鑫跃科技-技术部</td>
            </tr>
          </table>
        </td>
        <td width="8" background="images/tab_15.gif">&nbsp;</td>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="5%"><div align="center"><img src="images/tb.gif" width="16" height="16" /></div></td>
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[官方动态]</td>
              </tr>
            </table></td>
            <td width="54%">&nbsp;</td>
          </tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
          <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
              <td width="6%" class="td">官方网站：</td>
              <td width="94%" class="td"><a href="http://www.jsxyidc.com" target="_blank">鑫跃科技</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.yuleroom.cn/" target="_blank">XYCMS产品中心</a></td>
            </tr>
            <tr>
              <td class="td">官方店铺：</td>
              <td class="td"><a href="http://xycms.taobao.com/" target="_blank">http://xycms.taobao.com/</a></td>
            </tr>
          </table>
        </td>
        <td width="8" background="images/tab_15.gif">&nbsp;</td>
