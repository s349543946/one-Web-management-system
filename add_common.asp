                                      ...
                                      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#BDBFC8" width="94%" id="AutoNumber122" bgcolor="#F5F5F5" height="25">
                                        ...
                                        <tr> 
                                          ...
                                          <td width="76%" height="25"> &nbsp; 
                                            <input type="text" name="主负责人" id="主负责人"onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')" value=<%=session("主负责人")%>>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="主负责人是否是名人" type="text" id="主负责人是否是名人" value="否" maxLength=40 >
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                           	...
                                           	<%	temp="浙江温州"+xz %>
                                            <input type="text" name="主负责人籍贯" id="主负责人籍贯" value=<% =temp %> size="30" maxLength=40 >
                                            <font color="#ff0033">　<br>
			</td>
                                        </tr>
<tr> 
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                            <input name="副负责人是否是名人" type="text" id="副负责人是否是名人" value="否" maxLength=40 >
											<font color="#666666"><br>
										建议填写是或否！<br></font>
                                          </td>
                                        </tr>
...
<tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:12px ">
                                                	<%	temp="浙江温州"+xz %>
                                            <input type="text" name="副负责人籍贯" id="副负责人籍贯" value=<% =temp %> size="30" maxLength=40 >
                                            <font color="#ff0033">　<br>
			</td>
                                        </tr>
<tr> 
...
<a href="#"  onClick="javascript:show();"class="black">点此阅读泰顺商人网服务条款</a></font>
				...
				%></td>	
                                                <TD height=30 colspan="2"> <P align=center> 
       							<INPUT  type="button" name="submit1" value=" 该泰商名下还有其它企业提交 " onclick="send1();">
                                                    <INPUT  type="button" name="submit2" value=" 该泰商名下无其它企业提交 " onclick="send2();">
                                                    <BR>
                                                  </P></TD>
                                        </TR>
                                      </table>
