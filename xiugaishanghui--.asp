...
exec="select * from shanghui where 商会='"&request.Form("id")&"' ORDER BY ID "
rs.open exec,conn,1,1

set rsc=server.createobject("adodb.recordset") 
exec1="select * from wenshangxinxi where ID="&rs("会长")&" ORDER BY ID "
rsc.open exec1,conn,1,1

set rsc3=server.createobject("adodb.recordset") 
exec4="select * from wenshangxinxi where ID="&rs("常务副会长")&" ORDER BY ID "
rsc3.open exec4,conn,1,1

set rsc4=server.createobject("adodb.recordset") 
exec5="select * from wenshangxinxi where ID="&rs("秘书长")&" ORDER BY ID "
rsc4.open exec5,conn,1,1

set rsc5=server.createobject("adodb.recordset") 
exec6="select * from wenshangxinxi where ID="&rs("副秘书长")&" ORDER BY ID "
rsc5.open exec6,conn,1,1
%>
<body>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<link href="css/public.css" rel="stylesheet" type="text/css">
                              ...
                              <TBODY>
                                <TR> 
                                  <TD width="100%" height=30> <P align=center>+++ 
                                      商会信息修改 +++  <font color="#EC5106">(*必填)</font></P></TD>
                                </TR>
   ...
   <FORM name=addnew onSubmit="return checkform();" action="addnewdatashxg.asp?ac=adduser" method=post >
                                  ...
                                  <front>*</front>
										 ...
										 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="会长" id="会长"  maxlength=30 size="25" value=<%=rsc("姓名")%>>
                                  
                                           </td>
                                        </tr>
			 <tr> 
                                          <td width="24%" align="right" height="25">会长电话：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="会长电话" id="会长电话"  maxlength=30 size="25" value=<%=rs("会长电话")%>>
  					 ...
  					 <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="常务副会长" id="常务副会长"  maxlength=30 size="25" value=<%=rsc3("姓名")%>>
                                  
                                           </td>
                                        </tr>
	 <tr> 
                                          <td width="24%" align="right" height="25">常务副会长电话：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="常务副会长电话" id="常务副会长电话"  maxlength=30 size="25" value=<%=rs("常务副会长电话")%>>
                                         ...
                                         <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="秘书长" id="秘书长"  maxlength=30 size="25" value=<%=rsc4("姓名")%>>
                                  
                                           </td>
                                        </tr>
   </tr>
	 <tr> 
                                          <td width="24%" align="right" height="25">秘书长电话：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="秘书长电话" id="秘书长电话"  maxlength=30 size="25" value=<%=rs("秘书长电话")%>>
                                         ...
                                         <tr> 
                                          ...
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="副秘书长" id="副秘书长"  maxlength=30 size="25" value=<%=rsc5("姓名")%>>
                                  
                                           </td>
                                        </tr>
<tr> 
                                          <td width="24%" align="right" height="25">副秘书长电话：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="副秘书长电话" id="副秘书长电话"  maxlength=30 size="25" value=<%=rs("副秘书长电话")%> >
                                  
                                           </td>
                                        </tr>
    <tr> 
                                          <td width="24%" align="right" height="25">是否有党组：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="是否有党组" id="是否有党组"  maxlength=30 size="25" value=<%=rs("是否有党组")%> >
                                  
                                           </td>
                                        </tr>
                    <tr> 
                                          <td width="24%" align="right" height="25">商会地址：</td>
                                          <td width="76%" height="25" style="padding-left:8px ">
                                            <input type="text" name="商会地址" id="商会地址"  maxlength=30 size="25" value=<%=rs("商会地址")%> >
